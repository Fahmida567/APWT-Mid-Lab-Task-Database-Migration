...
class ProductController extends Controller
{
    ...
    public function listingProduct(Request $request)
    {
        $this->validate(
            ...
            [
                'p_name.required' => 'Required Field',
                'p_name.min' => 'Must not be less than 4 characters!',
                'p_name.max' => 'Must be less than 10 characters!',
                'p_code.required' => 'Required Field',
                'p_desc.required' => 'Required Field',
                'p_category.required' => 'Required Field',
                'p_price.regex' => 'Enter a valid input',
                'p_quantity.regex' => 'Enter a valid input',
                'p_rating.regex' => 'Enter a valid input',
                'p_purchased.required' => 'Required Field',
            ]
        );
